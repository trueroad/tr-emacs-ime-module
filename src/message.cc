...
constexpr WCHAR s_WM_TR_IME_EXISTS_SUBCLASSIFIED_[] =
  L"WM_TR_IME_EXISTS_SUBCLASSIFIED";
const UINT u_WM_TR_IME_EXISTS_SUBCLASSIFIED_ =
  RegisterWindowMessageW (s_WM_TR_IME_EXISTS_SUBCLASSIFIED_);
